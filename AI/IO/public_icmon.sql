...
-- ----------------------------
-- Sequence structure for sd_device__member_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."sd_device__member_id_seq";
CREATE SEQUENCE "public"."sd_device__member_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 2147483647
START 1
...
-- ----------------------------
-- Table structure for sd_device__member
-- ----------------------------
DROP TABLE IF EXISTS "public"."sd_device__member";
CREATE TABLE "public"."sd_device__member" (
  "id" int4 NOT NULL DEFAULT nextval('sd_device__member_id_seq'::regclass),
...
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."sd_device__member_id_seq"
OWNED BY "public"."sd_device__member"."id";
SELECT setval('"public"."sd_device__member_id_seq"', 1, false);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sd_iot_device_device_id_seq"', 47, true);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sd_iot_device_type_type_id_seq"', 2, true);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sd_iot_location_location_id_seq"', 4, true);
...
OWNED BY "public"."sd_iot_mqtt"."mqtt_id";
SELECT setval('"public"."sd_iot_mqtt_mqtt_id_seq8"', 57, true);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sd_user_log_id_seq"', 257, true);
...
-- ----------------------------
-- Indexes structure for table sd_device__member
-- ----------------------------
CREATE INDEX "IDX_214896a791bdab0abf21504353" ON "public"."sd_device__member" USING btree (
  "Device_id" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE INDEX "IDX_7e85420b3c4902d7cc5a66422a" ON "public"."sd_device__member" USING btree (
  "is_active" "pg_catalog"."bool_ops" ASC NULLS LAST
);
CREATE INDEX "IDX_a7448971330d43badd02784fd8" ON "public"."sd_device__member" USING btree (
  "group_id" "pg_catalog"."int4_ops" ASC NULLS LAST
);

-- ----------------------------
-- Uniques structure for table sd_device__member
-- ----------------------------
ALTER TABLE "public"."sd_device__member" ADD CONSTRAINT "unique_Device_group" UNIQUE ("Device_id", "group_id");

-- ----------------------------
-- Primary Key structure for table sd_device__member
-- ----------------------------
ALTER TABLE "public"."sd_device__member" ADD CONSTRAINT "PK_c569d8bc6914756075547e09590" PRIMARY KEY ("id");
...
-- ----------------------------
-- Foreign Keys structure for table sd_device__member
-- ----------------------------
ALTER TABLE "public"."sd_device__member" ADD CONSTRAINT "FK_214896a791bdab0abf215043538" FOREIGN KEY ("Device_id") REFERENCES "public"."sd_iot_device" ("device_id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "public"."sd_device__member" ADD CONSTRAINT "FK_a7448971330d43badd02784fd88" FOREIGN KEY ("group_id") REFERENCES "public"."sd_device_group" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
